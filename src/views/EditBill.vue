<template>
  ...
  <b-container id="app">
    <b-row>
      <b-col>
        <h3><i class="fas fa-angle-down text-muted mr-2" />Editer la facture {{ $route.params.id }}</h3>
        <hr />
      </b-col>
    </b-row>
      ...
      <b-row>
        <b-col lg="4">
          ...
          <b-form-group
            ...
            label-for="client"
          >
           <b-form-input id="client" v-model="fullname"></b-form-input>
          </b-form-group>
...
export default {
  ...
  mounted:function(){
        console.log(this.$route.params.bill.item);
        this.bill = this.$route.params.bill.item
  }
